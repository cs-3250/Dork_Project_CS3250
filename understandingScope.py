...
for a function except the Python keywords and the name of an existing built-in 
...
Once the function statements have been executed, program flow resumes at the 
point directly following the function call.  This modularity is very useful in 
...
("Scope") of variables in a program:
    ...
    inside functions - they have "global" scope.
